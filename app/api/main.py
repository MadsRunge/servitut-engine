...
from app.api.routes import auth, cases, declarations, documents, extraction, jobs, ocr, reports
...
app.include_router(declarations.router, prefix="/cases", tags=["declarations"])
